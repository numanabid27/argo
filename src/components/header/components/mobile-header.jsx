...
import carts from "../../../../public/assets/images/icons/shopping-cart.svg";
...
export default function MobileHeader() {
  ...
  return <Fragment>
      <FlexBetween width="100%">
        ...
        <Link href="/">
          <Image height={44} src="/assets/images/logo-image-dark.png" alt="logo" />
        </Link>
        ...
        <FlexBox justifyContent="end" flex={1}>
          ...
          <Badge badgeContent={state.cart.length} color="primary">
            <IconButton onClick={toggleSidenav}>
              <img src="/assets/images/icons/shopping-cart.svg" alt="cart-icon" width={25} height={25} />
            </IconButton>
          </Badge>
        </FlexBox>
      </FlexBetween>
